...
class _UpdateProfilePageState extends State<UpdateProfilePage> {
  ...
  // Load the current profile data from Firestore
    ...
    try {
      ...
      if (userDoc.exists) {
        setState(() {
          ...
          // Initialize the controller with the existing age
  ...
  void _saveProfile() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        // Save updated profile data to Firestore under 'users' collection
